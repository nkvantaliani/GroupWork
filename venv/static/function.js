const quizData = {
    1: [
        ...
        },
        {
            ...
            options: ["14 cm²", "24 cm²", "40 cm²", "44 cm²"],
            answer: "40 cm²"
        },
        {
    ...
    2: [
        ...
        [
            ...
            {
                question: "What does it mean if someone is a ‘Sigma Male’?",
                options: [
                    "They’re the alpha of the alphas", 
                    "They’re a lone wolf", 
                    "They have no rizz", 
                    "They just vibe"
                ],
                answer: "They’re a lone wolf"
            },
            {
            ...
            {
                question: "What’s the signature look of a ‘Sigma Boy’?",
                options: [
            ...
            {
                question: "What’s the ultimate Sigma move?",
                options: [
    ...
    [
        {
            question: "Which agent in Valorant is known for using a ‘Phoenix’ ability to heal and create walls of fire?",
            options: [
                "Phoenix", 
                "Brimstone", 
                "Sage", 
        ...
        {
            question: "What type of weapon is the ‘Vandal’ in Valorant?",
            options: [
                "Shotgun", 
                "Sniper", 
                "Rifle", 
        ...
        {
            question: "Which agent in Valorant has the ultimate ability called ‘Resurrection’?",
            options: [
                "Sage", 
                "Breach", 
                "Jett", 
        ...
        {
            question: "Which Valorant map features a location called ‘A Heaven’?",
            options: [
                "Bind", 
                "Ascent", 
                "Split", 
        ...
        {
            question: "What is the main function of the ‘Smoke’ ability in Valorant?",
            options: [
                "Healing teammates", 
                "Blocking vision", 
                "Planting bombs", 
...
const quizId = parseInt(urlParams.get('quiz'));//vighebt quizid-s romelic aweria website urlshi 🥰
